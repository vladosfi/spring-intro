...
//   getAll() {
//     return axiosPlugin.$http.get("/products");
//   },
//   getById(id) {
//     return axiosPlugin.$http.get(`/products/${id}`);
//   },
//   create(product) {
//     return axiosPlugin.$http.post("/products", product);
//   },
//   update(id, product) {
//     return axiosPlugin.$http.put(`/products/${id}`, product);
//   },
//   delete(id) {
//     return axiosPlugin.$http.delete(`/products/${id}`);
//   },
// };
